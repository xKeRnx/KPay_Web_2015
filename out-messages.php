			...
			<?php
				...
				if(!$conn){
					...
					if (isset($_GET['u'])) {
						...
						$checkMessage = sqlsrv_query($conn, "SELECT * FROM tMessage WHERE nUserID = ? AND sEnabled = 1 Order by dDate DESC;", array($_SESSION['nUserID']), array( "Scrollable" => SQLSRV_CURSOR_KEYSET ));
					}
