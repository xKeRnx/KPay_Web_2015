...
<body>
  ...
  <section class="content-wrap">
    ...
    <div class="container youplay-content">
      ...
      <div class="row">
          <!-- Activity -->
          <h2 class="mt-0">Payment Systems</h2>
          <div class="">
		  ...
		  <?php		
				...
				if(isset($_GET['DateTo'])){
					...
					echo '<form id="search" action="https://kernpay.com/user-psys" method="GET">';
					...
					echo '<table class="table table-hover" style="width:500px">';
					
					echo '<thead>';
					 echo ' <tr Style="font-size: 12px;">';
						echo '<th style="width:30%">Payment system</th>';
				...
				$RecEx = 0;
				$checkTransaction = sqlsrv_query($conn, "Select sStatus, Count(nUserID) as nUserID, SUM(cast (sAmount as float)) as  sAmount from tPurchases Where dDate >= Convert(datetime,?,103) AND dDate <= Convert(datetime,?,103) AND sValidate = 1 AND sEnabled = 1  GROUP BY sStatus Order by sAmount DESC OFFSET  ? ROWS FETCH NEXT ? ROWS ONLY;", array($DateFrom, $DateTo, $OFFSET, $Next), array( "Scrollable" => SQLSRV_CURSOR_KEYSET ));				
